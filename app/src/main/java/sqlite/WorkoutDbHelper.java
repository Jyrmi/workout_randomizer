...
public class WorkoutDbHelper extends SQLiteOpenHelper{
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + WorkoutContract.WorkoutEntry.TABLE_NAME + " (" +
                    WorkoutContract.WorkoutEntry._ID + " " + ID_TYPE + COMMA_SEP +
                    WorkoutContract.WorkoutEntry.COLUMN_WORKOUT + TEXT_TYPE + COMMA_SEP +
                    WorkoutContract.WorkoutEntry.COLUMN_DATE + TEXT_TYPE + " )";
